...
export const executeTransaction = async (contract, provider, functionname, input) => {
...
export const sendTx = async (contract, functionname, input) => {
  ...
  const tx = await contract[functionname](...input, { gasLimit: 300000 });
...
export const convertPricefromEth = async (n) => {
